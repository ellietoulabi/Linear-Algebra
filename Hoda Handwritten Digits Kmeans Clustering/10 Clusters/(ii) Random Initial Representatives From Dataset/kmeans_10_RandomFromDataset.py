...
#10 clusters with 10 random 0/1 initial representatives selected from original dataset
import numpy as np
...
def main():
    ...
    index = np.random.choice(20000,10, replace=False)
    init_rep = np.zeros((10,1200))
    
    for i in range(index.size):
        init_rep[i]=dataset[i]
