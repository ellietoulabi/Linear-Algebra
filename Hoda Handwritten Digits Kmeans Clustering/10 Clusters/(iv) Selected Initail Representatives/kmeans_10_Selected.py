...
def main():
    ...
    init_rep = np.zeros((10,1200))
    init_rep[0,:]=dataset[3000,:]
    init_rep[1,:]=dataset[16165,:]
    init_rep[2,:]=dataset[3,:]
    init_rep[3,:]=dataset[20,:]
    init_rep[4,:]=dataset[19724,:]
    init_rep[5,:]=dataset[50,:]
    init_rep[6,:]=dataset[18603,:]
    init_rep[7,:]=dataset[4000,:]
    init_rep[8,:]=dataset[13966,:]
    init_rep[9,:]=dataset[10000,:]
